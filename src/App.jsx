...
import { ArrowUpRight, Award, BookOpen, Briefcase, Database, Mail, Shield, Sparkles } from "lucide-react";

const metrics = [
  { value: "4,500+", label: "Enterprise tenants" },
  { value: "100M+", label: "Records processed annually" },
  { value: "25%", label: "Login success improvement" },
  { value: "$1M+", label: "Efficiency / cost impact" },
];

const focusAreas = [
  { icon: Shield, title: "Identity & Authentication", text: "IAM, SSO, passwordless login, governance, and secure enterprise access experiences." },
  { icon: Database, title: "Data Management Systems", text: "DMS, metadata discovery, document processing, classification, secure ingestion, and governance-aware data flows." },
  { icon: Briefcase, title: "Enterprise Platforms", text: "Platform capabilities across APIs, integrations, compliance, cloud infrastructure, and scalable SaaS foundations." },
  { icon: Sparkles, title: "FinTech & Analytics", text: "Banking and wealth platforms, churn analytics, pricing strategy, and data-led decision systems." },
];
...
const experience = [
  ...
  {
    role: "Product Owner — Banking & Wealth Platforms",
    ...
    points: [
      ...
      "Improved adoption and daily usage through better transaction UX, automation, experimentation, and release coordination.",
    ],
  },
];
...
const projects = [
  {
    ...
    image: "/projects/identity-data-platform.png",
    chips: ["IAM", "DMS", "Governance", "Metadata"],
    detail: "Owned platform product areas across authentication, identity, DMS, document processing, and metadata extraction. Focused on scalable enterprise architecture, privacy-aware controls, and improving the usability and trust of core platform workflows.",
  },
  {
    ...
    image: "/projects/banking-wealth-platform.png",
    chips: ["Payments", "Migration", "UX", "Automation"],
    detail: "Worked on banking and wealth platforms spanning omnichannel transactions, operational workflows, and migration into more unified platform experiences. Improved consistency, automation, and customer-facing transaction journeys.",
  },
  {
    ...
    detail: "Built a predictive churn analysis approach centered on high-value users, customer lifecycle signals, and early detection of retention risk. The project focused on identifying leading indicators that could support proactive intervention strategies.",
  },
  {
    ...
    image: "/projects/airbnb-optimization.png",
    chips: ["Marketplace", "Pricing", "Demand", "UX"],
    detail: "Analyzed listing demand, pricing, room-type preferences, and neighborhood dynamics to surface opportunities around acquisition strategy, ranking, and supply-demand optimization in the NYC market.",
  },
  {
    ...
    detail: "Built investor-specific portfolio recommendations using risk-return analysis, sector comparison, and benchmark evaluation against the S&P 500. Focused on translating quantitative insights into practical portfolio decisions.",
  },
];

const productPlatformGroups = [
  { title: "Product", skills: ["Product Strategy", "Roadmapping", "GTM", "Experimentation", "Wireframing"] },
  { title: "Platform", skills: ["IAM", "Authentication", "DMS", "APIs & Integrations", "Enterprise SaaS"] },
];
...
const certifications = [
  { name: "Enterprise Product Management Fundamentals — Microsoft", logo: "/logos/certifications/microsoft.svg" },
  { name: "Database Management Essentials — University of Colorado System", logo: "/logos/certifications/colorado.svg" },
  { name: "Software Development Processes and Methodologies — University of Minnesota", logo: "/logos/certifications/minnesota.svg" },
  { name: "Oracle Certified Associate, Java SE 8 Programmer", logo: "/logos/certifications/oracle.svg" },
...
const achievements = [
  ...
  "Gem Award — Q2 FY24",
  "Publication: Using Decision Trees to Predict Concrete Compressive Strength",
];
  ...
  return (
    <div className="ambient-bg">
      ...
      {Array.from({ length: 18 }).map((_, i) => (
        <motion.div key={i} className="floating-dot" style={{ left: `${(i * 5.2) % 100}%`, top: `${(i * 11.3) % 100}%` }} animate={{ y: [0, -20, 0], opacity: [0.2, 0.9, 0.2] }} transition={{ duration: 3 + (i % 5), repeat: Infinity, ease: "easeInOut", delay: i * 0.15 }} />
      ))}
    </div>
  );
}
      ...
      <div className="page-content">
            ...
            <div className="snapshot-card">
              ...
              <div className="snapshot-header">
                <div className="profile-photo-wrap">
                  ...
                  <img src="/profile/Icims_Passport.png" alt="A V Sasidhar" className="profile-photo" />
                </div>
                <div>
        ...
        <section id="skills" className="two-col">
          <div className="tools-panel">
            ...
            <div className="stack compact">
              {productPlatformGroups.map((group) => (
                <div key={group.title}>
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="modal-backdrop" onClick={() => setActiveProject(null)}>
              <motion.div initial={{ opacity: 0, scale: 0.96, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.96, y: 20 }} transition={{ duration: 0.2 }} className="modal-card" onClick={(e) => e.stopPropagation()}>
                <div className="modal-close-row">
                  <button type="button" onClick={() => setActiveProject(null)} className="modal-close">×</button>
                </div>
                <div className="modal-inner">
                  <div className="modal-grid">
                    ...
                    <div>
                      ...
                      <p className="modal-copy">{activeProject.detail}</p>
                    </div>
                  </div>
                </div>
              </motion.div>
        ...
        <section id="contact" className="contact-section">
          ...
          <div className="contact-list">
            ...
            <a href="tel:7702489741"><span>📞</span> 7702489741</a>
            <a href="https://www.linkedin.com/in/sasidhar-ayalavarapu-729116173/" target="_blank" rel="noreferrer"><span>🔗</span> LinkedIn Profile</a>
          </div>
        </section>
      </div>
    </div>
