...
const focusAreas = [
  {
    ...
    text: "IAM, SSO, passwordless login, governance, and secure enterprise access experiences.",
  },
  {
    icon: Database,
...
const experience = [
  {
    ...
    company: "iCIMS",
    companyLogo: "/logos/companies/icims.svg",
  ...
  },
  {
    ...
    companyLogo: "/logos/companies/virtusa.svg",
    secondaryLogo: "/logos/companies/citi.svg",
...
const projects = [
  {
    ...
    detail:
      "Owned platform product areas across authentication, identity, DMS, document processing, and metadata extraction. Focused on scalable enterprise architecture, privacy-aware controls, and improving the usability and trust of core platform workflows.",
  },
  {
    ...
    detail:
      "Worked on banking and wealth platforms spanning omnichannel transactions, operational workflows, and migration into more unified platform experiences. Improved consistency, automation, and customer-facing transaction journeys.",
  },
  {
    ...
    detail:
      "Built a predictive churn analysis approach centered on high-value users, customer lifecycle signals, and early detection of retention risk. The project focused on identifying leading indicators that could support proactive intervention strategies.",
  },
  {
    ...
    detail:
      "Analyzed listing demand, pricing, room-type preferences, and neighborhood dynamics to surface opportunities around acquisition strategy, ranking, and supply-demand optimization in the NYC market.",
  },
  {
    ...
    detail:
      "Built investor-specific portfolio recommendations using risk-return analysis, sector comparison, and benchmark evaluation against the S&P 500. Focused on translating quantitative insights into practical portfolio decisions.",
  },
];
...
const skillGroups = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "SQL", logo: "/logos/tools/sql.svg" },
      { name: "Java", logo: "/logos/tools/java.svg" },
      { name: "C/C++", logo: "/logos/tools/cpp.svg" },
      { name: "React", logo: "/logos/tools/react.svg" },
      { name: "Spring Boot", logo: "/logos/tools/springboot.svg" },
    ],
  },
  {
    title: "AI / Data",
    skills: [
      { name: "Machine Learning", logo: "/logos/tools/scikitlearn.svg" },
      { name: "Python", logo: "/logos/tools/python.svg" },
      { name: "NLP", logo: "/logos/tools/spacy.svg" },
      { name: "Analytics", logo: "/logos/tools/tableau.svg" },
    ],
  },
];
...
const certifications = [
  {
    name: "Enterprise Product Management Fundamentals — Microsoft",
    logo: "/logos/certifications/microsoft.svg",
  },
  {
    name: "Database Management Essentials — University of Colorado System",
    logo: "/logos/certifications/colorado.svg",
  },
  {
    name: "Software Development Processes and Methodologies — University of Minnesota",
    logo: "/logos/certifications/minnesota.svg",
  },
  {
    name: "Oracle Certified Associate, Java SE 8 Programmer",
    logo: "/logos/certifications/oracle.svg",
  },
  {
    name: "Angular Certification L1 / Junior Angular Developer",
    logo: "/logos/certifications/angular.svg",
  },
];
...
const education = [
  {
    ...
    logo: "/logos/education/isb.svg",
    detail: "PGP in Management",
  },
  {
    school: "IIIT Bangalore",
    logo: "/logos/education/iiitb.svg",
    detail: "Executive Program in Data Science",
  },
  {
    school: "GITAM",
    logo: "/logos/education/gitam.svg",
    ...
    <div className="ambient-bg">
      ...
      {Array.from({ length: 18 }).map((_, i) => (
        <motion.div
          ...
          style={{ left: `${(i * 5.2) % 100}%`, top: `${(i * 11.3) % 100}%` }}
                  ...
                  <div className="chip-row">
                    {group.skills.map((skill) => (
                      <span key={skill.name} className="skill-chip">
                        {skill.logo ? <img src={skill.logo} alt={skill.name} className="skill-logo" /> : null}
                        {skill.name}
                      </span>
                    ))}
                  </div>
